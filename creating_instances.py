from helpers import *  # Import necessary helper functions (assumes `create_ubuntu_instance`, `create_amazon_linux_2023_instance`, `create_amazon_linux_2_instance`, `get_ec2_client` exist)
